...
const Navbar = props => {
    const items = [
        ...
        { id: 'mainNav3', name: 'Messages', link: '/messages/dialogs', icon: messagesIcon },
        // { id: 'mainNav4', name: 'News', link: '/news', icon: newsIcon },
        // { id: 'mainNav5', name: 'Images', link: '/images', icon: imagesIcon },
        // { id: 'mainNav5', name: 'Music', link: '/music', icon: musicIcon },
        { id: 'mainNav6', name: 'Settings', link: '/settings', icon: settingsIcon }
    ]
